...
router.route("/api/admin/:id/update/profile").put(AdminCtrl.updateProfile);
router.route("/api/admin/:id/update/bankInfo").put(BankCtrl.updateOrCreate);         //Bank Controller
router.route("/api/admin/:id/get/bankInfo").get(BankCtrl.get);
