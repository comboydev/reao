...
const ProductList = () => {
	...
	const addProduct = () => {
		history.push(`${APP_PREFIX_PATH}/product/add`)
	}
	
	const viewDetails = row => {
		history.push(`${APP_PREFIX_PATH}/product/edit/${row.id}`)
	}
	...
	return (
		<Card>
			<Flex alignItems="center" justifyContent="between" mobileFlex={false}>
				...
				<div>
					<Button onClick={addProduct} type="primary" icon={<PlusCircleOutlined />} block>Add News</Button>
				</div>
			</Flex>
